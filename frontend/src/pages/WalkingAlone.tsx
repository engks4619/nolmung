...
//   const [myPosition, setMyPosition] = useState<Geoloc | null >(null);
...
//         setpolylinePath(walkingLog); //walkingLog가 있고 길이 2 이상이면 state에 갈아 끼워줌
//         return true;
//       } }
//     Geolocation.getCurrentPosition(
//       info => {
...
//           longitude: info.coords.longitude,
//         }
//         setpolylinePath([currentLoc,currentLoc])
//       },console.error,
//       {enableHighAccuracy: true},
//     )
//     return true
